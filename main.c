...
int checkIfHttp(unsigned char *payload)
{
	int i, j;
	char keyword[10][10] = {
		"GET",
...
int checkIfHarmful(char *payload, int size)
{
	...
	if(strncmp(payload+hostFieldIndex, harmfulWebHost, harmfulLength) == 0)
	{
		printf("Blocked!\n");
		return 1;
	}
...
static u_int32_t print_pkt (struct nfq_data *tb)
{
	...
	payloadData = (unsigned char*)(data + ipHeaderLen  + tcpHeaderLen);
